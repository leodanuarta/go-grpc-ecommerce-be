...
func (x *ListProductItem) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ListProductItem) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ListProductItem) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
func (x *ListProductItem) GetPrice() float64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *ListProductItem) GetImageUrl() string {
	if x != nil {
		return x.ImageUrl
	}
	return ""
...
type ListProductResponse struct {
	...
	Data          []*ListProductItem         `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListProductResponse) GetData() []*ListProductItem {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_product_product_proto_rawDesc = "" +
	"\n" +
	"\x15product/product.proto\x12\aproduct\x1a\x17common/pagination.proto\x1a\x1acommon/base_response.proto\x1a\x1bbuf/validate/validate.proto\"\xbe\x01\n" +
	...
	"pagination\"\x8a\x01\n" +
	"\x0fListProductItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x04 \x01(\x01R\x05price\x12\x1b\n" +
	"\timage_url\x18\x05 \x01(\tR\bimageUrl\"\xa9\x01\n" +
	...
	"pagination\x12,\n" +
	"\x04data\x18\x03 \x03(\v2\x18.product.ListProductItemR\x04data2\x94\x03\n" +
	...
	"\vListProduct\x12\x1b.product.ListProductRequest\x1a\x1c.product.ListProductResponseB\n" +
...
var file_product_product_proto_goTypes = []any{
	...
	(*ListProductItem)(nil),           // 9: product.ListProductItem
...
var file_product_product_proto_depIdxs = []int32{
	...
	9,  // 7: product.ListProductResponse.data:type_name -> product.ListProductItem

...
type PaginationResponse struct {
	...
	CurrentPage    int32                  `protobuf:"varint,1,opt,name=current_page,json=currentPage,proto3" json:"current_page,omitempty"`
	ItemPerPage    int32                  `protobuf:"varint,2,opt,name=item_per_page,json=itemPerPage,proto3" json:"item_per_page,omitempty"`
	TotalItemCount int32                  `protobuf:"varint,3,opt,name=total_item_count,json=totalItemCount,proto3" json:"total_item_count,omitempty"`
	TotalPageCount int32                  `protobuf:"varint,4,opt,name=total_page_count,json=totalPageCount,proto3" json:"total_page_count,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_common_pagination_proto_rawDesc = "" +
	...
	"\fcurrent_page\x18\x01 \x01(\x05R\vcurrentPage\x12\"\n" +
	"\ritem_per_page\x18\x02 \x01(\x05R\vitemPerPage\x12(\n" +
	"\x10total_item_count\x18\x03 \x01(\x05R\x0etotalItemCount\x12(\n" +
	"\x10total_page_count\x18\x04 \x01(\x05R\x0etotalPageCountB\tZ\a/commonb\x06proto3"
